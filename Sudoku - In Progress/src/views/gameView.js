...
export function showGame(ctx) {
    ...
    <section id="game">
        ...
        <div id="leveling">
            <button data-set="false" id="easyBtn" @click=${onCheck}>What is this sudoku game</button>
            <button data-set="false" id="normalBtn" @click=${onCheck}>I play from time to time</button>
            <button data-set="false" id="hardBtn" @click=${onCheck}>Sudoku is my middle name</button>
        </div>
